...
set plugin_namespace       /mflux/plugins/unimelb-mf-omeka-plugin
set plugin_zip             unimelb-mf-omeka-plugin.zip
set plugin_jar             unimelb-mf-omeka-plugin.jar
set module_class           unimelb.mf.omeka.plugin.OmekaPluginModule
